...
unsigned int __attribute__((weak)) ethosu_config_select(uint64_t address, int index)
{
    ...
    switch (index)
    {
    case -1: return NPU_QCONFIG;
    default:
    case 0: return NPU_REGIONCFG_0;
    case 1: return NPU_REGIONCFG_1;
    case 2: return NPU_REGIONCFG_2;
    case 3: return NPU_REGIONCFG_3;
    case 4: return NPU_REGIONCFG_4;
    case 5: return NPU_REGIONCFG_5;
    case 6: return NPU_REGIONCFG_6;
    case 7: return NPU_REGIONCFG_7;
    }
}
